...
public class QRCodeActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler{
    ...
    private boolean checkPermission(){
        return (ContextCompat.checkSelfPermission( QRCodeActivity.this , CAMERA) == PackageManager.PERMISSION_GRANTED) & (ContextCompat.checkSelfPermission( QRCodeActivity.this , CALL_PHONE) == PackageManager.PERMISSION_GRANTED) ;
    }
